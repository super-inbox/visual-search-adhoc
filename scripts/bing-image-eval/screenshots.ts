...
const SCREENSHOTS_BASE = path.join(
  ROOT,
  "docs/external-signal-pilot/bing-image-eval-58/screenshots",
);
...
export async function takeScreenshots(
  ...
  const file1 = path.join(dir, "bing-images-page1.png");
  ...
  const file2 = path.join(dir, "bing-images-page2.png");
