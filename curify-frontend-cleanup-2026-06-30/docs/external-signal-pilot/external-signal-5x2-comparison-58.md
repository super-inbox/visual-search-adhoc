...
| Curify Search | PASS | 53/58 ok, 5/58 ok_empty | 8.7 | 7.7/10 | 5 ok_empty, 20 topResults<10 — primary analysis focus | `docs/external-signal-pilot/curify-search-eval-58/` |
...
**Creative topResults<10 (P0/P1) — 15 queries:**
...
| phonics worksheets kindergarten | 4 | 10 | 10 | template_gap | P1 | Add dedicated templates for this creative intent; check alias coverage |
| Spanish vocabulary printable | 4 | 10 | 10 | template_gap | P1 | Add dedicated templates for this creative intent; check alias coverage |
| ESL flashcards printable | 4 | 10 | 10 | template_gap | P1 | Add dedicated templates for this creative intent; check alias coverage |
| bilingual flashcards for kids learning korean fruits | 5 | 10 | 10 | template_gap | P1 | Add dedicated templates for this creative intent; check alias coverage |
| 趣味经济学知识科普 | 6 | 10 | 10 | template_gap | P1 | Add dedicated templates for this creative intent; check alias coverage |
| book lovers gift guide | 6 | 10 | 10 | template_gap | P1 | Add dedicated templates for this creative intent; check alias coverage |
...
| historical character | 9 | retrieval_gap | Audit aliases and tokenization; check if content exists but isn't being recalled |
...
| samurai | 10 | 10 | 10 | 10 | 10 | Performing adequately; monitor for regression |
| mbti marvel | 8 | 10 | 10 | 10 | 10 | Audit aliases and tokenization; check if content exists but isn't being recalled |
...
| phonics worksheets kindergarten | creative | 4 | 10 | 10 | template_gap | Add dedicated templates for this creative intent; check alias coverage |
| Spanish vocabulary printable | creative | 4 | 10 | 10 | template_gap | Add dedicated templates for this creative intent; check alias coverage |
| ESL flashcards printable | creative | 4 | 10 | 10 | template_gap | Add dedicated templates for this creative intent; check alias coverage |
| bilingual flashcards for kids learning korean fruits | creative | 5 | 10 | 10 | template_gap | Add dedicated templates for this creative intent; check alias coverage |
| 趣味经济学知识科普 | creative | 6 | 10 | 10 | template_gap | Add dedicated templates for this creative intent; check alias coverage |
| book lovers gift guide | creative | 6 | 10 | 10 | template_gap | Add dedicated templates for this creative intent; check alias coverage |
...
| historical character | consumer | 9 | 40 | retrieval_gap | Audit aliases and tokenization; check if content exists but isn't being recalled |
| mbti marvel | creative | 7 | 40 | retrieval_gap | Audit aliases and tokenization; check if content exists but isn't being recalled |
...
| cuban sandwich recipe poster | creative | 6 | 40 | retrieval_gap | Audit aliases and tokenization; check if content exists but isn't being recalled |
...
| **P2** | historical character | retrieval_gap | Curify ok(9); Google=10,Bing=10,Pinterest=10… | Audit aliases and tokenization; check if content exists but  | search/retrieval |
...
| **P2** | mbti marvel | retrieval_gap | Curify ok(8); Google=10,Bing=10,Pinterest=10… | Audit aliases and tokenization; check if content exists but  | search/retrieval |
...
| **P2** | cuban sandwich recipe poster | retrieval_gap | Curify ok(8); Google=10,Bing=10,Pinterest=10… | Audit aliases and tokenization; check if content exists but  | search/retrieval |
| **P1** | bilingual flashcards for kids learning korean fruits | template_gap | Curify ok(5); Google=10,Bing=10,Pinterest=10… | Add dedicated templates for this creative intent; check alia | content/template |
...
| **P1** | phonics worksheets kindergarten | template_gap | Curify ok(4); Google=10,Bing=10,Pinterest=10… | Add dedicated templates for this creative intent; check alia | content/template |
| **P1** | Spanish vocabulary printable | template_gap | Curify ok(4); Google=10,Bing=10,Pinterest=10… | Add dedicated templates for this creative intent; check alia | content/template |
| **P1** | ESL flashcards printable | template_gap | Curify ok(4); Google=10,Bing=10,Pinterest=10… | Add dedicated templates for this creative intent; check alia | content/template |
...
| **P1** | book lovers gift guide | template_gap | Curify ok(6); Google=10,Bing=10,Pinterest=10… | Add dedicated templates for this creative intent; check alia | content/template |
