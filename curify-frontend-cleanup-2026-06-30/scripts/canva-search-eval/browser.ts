...
const PROFILE_DIR = path.join(ROOT, ".cache/canva-search-eval-profile");

export const VIEWPORT = { width: 1536, height: 960 };

// Primary URL pattern — https://www.canva.com/templates/?query=<encoded>
// Canva may redirect to a canonical form; the collector saves finalUrl.
export const CANVA_URL_PATTERN = "https://www.canva.com/templates/?query=";
...
export function buildCanvaSearchUrl(query: string): string {
  return `${CANVA_URL_PATTERN}${encodeURIComponent(query)}`;
}
